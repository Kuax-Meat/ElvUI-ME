-- EquippedItemLevel AddOn by villiv
-- http://www.wowinterface.com/downloads/info19509-EquippedItemLevel.html

local E, L, P, G = unpack(ElvUI); --Import: Engine, Locales, ProfileDB, GlobalDB
local TT = E:GetModule('Tooltip')

function TT:EquippedItemLevel()
	if E.db.meat.ttilvl ~= true then return end
