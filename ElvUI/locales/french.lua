...
L["Enable"] = "Activer"
L["EnableDisable the all-in-one bag."] = "Activer / Désactiver les sacs tout-en-un."
L["EnableDisable the loot frame."] = "Activer / Désactiver le cadre du butin."
L["EnableDisable the loot roll frame."] = "Active / Désactive le cadre de butin"
...
L["Panels"] = "Panneaux"
L["Panel Texture (Left)"] = "Texture du panneaux (gauche)"
L["Panel Texture (Right)"] = "Texture du panneaux (droit)"
L["Panel Width"] = "Largeur des panneaux"
L["Party Frames"] = "Cadre de groupe"
L["Party Pets"] = "Pets du groupe"
L["Party Targets"] = "Cible par le Groupe"
L["Percent"] = "Pourcent"
...
L["Primary Layout Set"] = "Première disposition réglée."
...
L["Reset the current profile to match default settings from the primary layout."] = "Réinitialiser le profil actuel pour qu'il corresponde aux réglage par défaut de la disposition principale."
L["Rested:"] = "Reposé: "
...
L["Secondary Layout Set"] = "Seconde disposition réglée."
...
L["Your version of ElvUI is out of date. You can download the latest version from www.curse.com"] = "Votre version d'ElvUi est périmé. Vous pouvez télécharger la dernière version sur www.curse.com"
