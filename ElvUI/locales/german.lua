...
L["Multi-Spec Swap"] = "Multi-Spec Wechsel"
L["Name"] = "Name"
...
L["Reset the current profile to match default settings from the primary layout."] = "Aktives Profil zurücksetzen und Standarteinstellungen des Primären Layouts übernehmen."
L["Rested:"] = "Ausgeruht:"
...
L["Secondary Talents"] = "Zweite Talentspezialisierung"
...
L["Swap to an alternative layout when changing talent specs. If turned off only the spec #1 layout will be used."] = "Wechsle zu einem alternativen Layout wenn du die Talentspezialisierung änderst. Es ist ausgestellt wenn einschließlich #1 layout genutzt wird."
...
L["You can now choose what layout you wish to use for your primary talents."] = "Du kannst nun wählen welches Layout für deine Erste Talentspezialisierung benutzt werden soll."
L["You can now choose what layout you wish to use for your secondary talents."] = "Du kannst nun wählen welches Layout für deine Zweite Talentspezialisierung benutzt werden soll."
