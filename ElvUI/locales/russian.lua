...
L["Enable"] = "Включить"
L["EnableDisable the all-in-one bag."] = "Включить/выключить режим сумки 'все в одной'."
L["EnableDisable the loot frame."] = "Включить/выключить окно добычи ElvUI."
L["EnableDisable the loot roll frame."] = "Включить/выключить фрейм распределения добычи ElvUI."
