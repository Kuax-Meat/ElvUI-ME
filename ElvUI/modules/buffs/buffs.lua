...
if C["general"].upperpanel ~= true then
	...
	holder:SetPoint("TOPRIGHT", Minimap, "TOPLEFT", E.Scale(-8), -E.Scale(33))
end
holder:SetWidth(E.Scale(456)) --(30 + 8) * 12)
holder:SetHeight(ElvuiMinimap:GetHeight() + E.Scale(3 + 19))

--Debuff Holder frame for mover by meat
local dholder = CreateFrame("Frame", "DBFAurasHolder", E.UIParent)
if C["general"].upperpanel ~= true then
	dholder:SetPoint("TOPRIGHT", Minimap, "BOTTOMLEFT", E.Scale(-8), -E.Scale(6))
else
	dholder:SetPoint("TOPRIGHT", Minimap, "BOTTOMLEFT", E.Scale(-8), -E.Scale(41))
end
dholder:SetWidth(E.Scale(456)) --(30 + 8) * 12)
dholder:SetHeight(E.Scale(30))
...
function E.AurasPostDrag(frame)
	...
	if E.Movers and not E.Movers["DAurasMover"] or not E.Movers then
		DAurasMover:ClearAllPoints()
		if C["general"].upperpanel ~= true then
			DAurasMover:SetPoint("TOPRIGHT", Minimap, "BOTTOMLEFT", E.Scale(-8), -E.Scale(6))
		else
			DAurasMover:SetPoint("TOPRIGHT", Minimap, "BOTTOMLEFT", E.Scale(-8), -E.Scale(41))
		end
	end
end

E.CreateMover(AurasHolder, "AurasMover", "Auras Frame", false, E.AurasPostDrag)
E.CreateMover(DBFAurasHolder, "DAurasMover", "Debuff Auras Frame", false, E.DAurasPostDrag)
