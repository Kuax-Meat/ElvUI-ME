...
oUF.Tags['Elvui:nameshort'] = function(unit)
	...
	if colorblind ~= 1 then
		...
		if (UnitIsPlayer(unit)) then
			...
			return (utf8sub((name), 5, false)).." |TInterface\\WorldStateFrame\\Icons-Classes:25:25:0:0:256:256:"..tostring(texcoord[1]*256)..":"..tostring(texcoord[2]*256)..":"..tostring(texcoord[3]*256)..":"..tostring(texcoord[4]*256).."|t"
		else
			return utf8sub(name, 5, false)
		end
	end
