...
local function LoadDPSLayout()
	...
	player:Point("BOTTOMLEFT", ElvuiSplitActionBarLeftBackground, "TOPLEFT", 0, 70)
	player:Size(PLAYER_WIDTH, PLAYER_HEIGHT)

	-- Target
	local target = oUF:Spawn('target', "ElvDPS_target")
	target:Point("BOTTOMRIGHT", ElvuiSplitActionBarRightBackground, "TOPRIGHT", 0, 70)
	...
	tot:Point("BOTTOM", ElvuiActionBarBackground, "TOP", 0, 70)
	...
	if C["unitframes"].showfocustarget == true then
		...
		focustarget:Point("BOTTOM", ElvDPS_focus, "BOTTOMRIGHT", 62, 0)
