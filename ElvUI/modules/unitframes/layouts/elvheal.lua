...
local function Shared(self, unit)
	...
	if unit == "player" then
		...
		if C["unitframes"].charportrait == true then
			if C["unitframes"].charportraithealth == true then
				...
				if POWERTHEME == true or USE_POWERBAR_OFFSET == true then
					...
					portrait.backdrop:Point("BOTTOMRIGHT", power.backdrop, "BOTTOMLEFT", -4, 0)
				end
		...
		if C["unitframes"].unitcastbar == true then
			...
			castbar:Point("CENTER", E.UIParent, "CENTER", 0, -145)
	...
	if unit == "target" then
		...
		if C["unitframes"].charportrait == true then
			if C["unitframes"].charportraithealth == true then
				...
				if POWERTHEME == true or USE_POWERBAR_OFFSET == true then
					...
					portrait.backdrop:Point("BOTTOMLEFT", power.backdrop, "BOTTOMRIGHT", 4, 0)
				end				
				portrait.backdrop:SetFrameLevel(portrait:GetFrameLevel() - 1)
		...
		if C["unitframes"].unitcastbar == true then
			...
			castbar:Point("CENTER", E.UIParent, "CENTER", 0, -120)
	...
	if (unit == "targettarget" or unit == "pet" or unit == "pettarget" or unit == "focustarget" or unit == "focus") then
		...
		elseif unit == "focus" and C["unitframes"].unitcastbar == true	then
			--Cast Bar
			local castbar = E.ConstructCastBar(self, CASTBAR_WIDTH, CASTBAR_HEIGHT, "LEFT")
			castbar:Point("CENTER", E.UIParent, "CENTER", 0, 110)
...
local function LoadHealLayout()
	...
	if C["unitframes"].showfocustarget == true then
		...
		focustarget:Point("BOTTOMLEFT", ElvHeal_focus, "BOTTOMRIGHT", 5, 0)
	...
	if C.unitframes.arena then
		...
		for i = 1, 5 do
			...
			if i == 1 then
				arena[i]:Point("BOTTOMLEFT", ChatRBGDummy, "TOPLEFT", 60, 205)
			else
	...
	if C["unitframes"].showboss then
		...
		for i = 1, MAX_BOSS_FRAMES do
			...
			if i == 1 then
				boss[i]:Point("BOTTOMLEFT", ChatRBGDummy, "TOPLEFT", 60, 205)
			else
